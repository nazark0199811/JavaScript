 ...
 */
 ...
 function getDateAgo(date, days) {
  ...
  return myDate.toLocaleString().replace(/(\d.*),\s+(\d.*)/gu, '$1');;
 }
...
let Car = function(engine, model, name, year) {
  ...
  Car.prototype.info = info;

  Object.defineProperty(Car.prototype, 'used', {
...
if (typeof func === 'function' && iterations--) {
  func();
}
