...
//     : number < 24 ? 'детский возраст'
//     : number < 44 ? 'молодой возраст'
//     : number < 65 ? 'средний возраст'
//     : number < 75 ? 'пожилой возраст'
//     : number < 90 ? 'старческий возраст'
//     : number < 122 ? 'долгожители'
//     : null;
//  }
...
const list = {
   ...
   function ageClassification(number){
       const ages = Object.keys(list);
     const age = ages.find((age) => number <= age && number > 0);
     return age ? list[age] : null;
    }
